		...
		(function(t, e, i, r) {
			...
			i.extend(y.prototype, u, {
				...
				save : function(t, e, r) {
					...
					var l = this.isNew() ? "create" : r.patch ? "patch"
							: "update";
					if (l === "patch" && !r.attrs)
						r.attrs = n;
				...
				url : function() {
					var t = i.result(this, "urlRoot")
							|| i.result(this.collection, "url") || F();
					if (this.isNew())
						return t;
			...
			i.extend(x.prototype, u, {
				...
				set : function(t, e) {
					...
					var g = i.isString(this.comparator) ? this.comparator
							: null;
					var p, m;
			...
			var T = /^(\S+)\s*(.*)$/;
			var P = [ "model", "collection", "el", "id", "attributes",
			...
			i.extend($.prototype, u, {
				...
				_routeToRegExp : function(t) {
					t = t.replace(j, "\\$&").replace(A, "(?:$1)?").replace(C,
							function(t, e) {
								return e ? t : "([^/?]+)"
							}).replace(R, "([^?]*?)");
							...
							u,
							{
								...
								start : function(t) {
									...
									if (!this._hasHashChange
										...
										var r = document.body;
										var n = r.insertBefore(this.iframe,
